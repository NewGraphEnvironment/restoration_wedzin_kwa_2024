...
```{r model2-riparian}
model_url <- '<iframe src="https://sketchfab.com/models/4b9b0ffd5e894e2fa8ae1689391c27b6/embed" scrolling="no" title="20241015_dogwoodmulchirrigation" width="100%" height="600" frameBorder ="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" allow="autoplay; fullscreen;xr-spatial-tracking"></iframe>'
...
my_caption = paste0('3D model showing example of implemented prescription following 3 growing seasons.  Prescription incorporates 1m spacing of red-osier dogwood cuttings havested while dormant and soaked for 48hrs, sod removal, soil amendment (bone meal), installation of biodegradable weed competition barrier (cardboard), 8 inches of non-acidic mulch (fir and maple) and automated drip irrigation running for 30 minutes every second day during growing season.')
