...
Habitat restoration in the Neexdzii Kwah is necessary but not sufficient for salmon population recovery. Skeena chinook and coho show sustained declines consistent with exploitation rates exceeding what these populations can sustain [@winther_etal2024assessmentskeena; @lglltd_2025SkeenaRiver; @price_etal2026rebuildinggiis]. Rebuilding habitat capacity is the prerequisite for population recovery when exploitation is eventually reduced — but the prioritization framework that follows cannot promise recovery without parallel action on harvest.
