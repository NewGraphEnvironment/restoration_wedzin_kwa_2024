...
Habitat restoration in the Neexdzii Kwah is necessary but not sufficient for salmon population recovery. Skeena chinook and coho show sustained declines driven by fishing pressure — both marine and in-river — that exceeds what these populations can sustain [@winther_etal2024assessmentskeena; @lglltd_2025SkeenaRiver; @price_etal2026rebuildinggiis]. Reducing harvest is the necessary precondition for recovery; without it, restored habitat produces fish that are removed before they can spawn. Rebuilding habitat capacity now ensures the watershed can support recovery when harvest rates are brought in line with current productivity.
